 ...
 */
#define FAN_MIN_PWM 20 //For Delta fan
 ...
 */
  ...
  #define PROBE_PT_1_X ((X_MIN_POS) + 30)
  #define PROBE_PT_1_Y ((Y_MIN_POS) + 30)
  #define PROBE_PT_2_X ((X_BED_SIZE) / 2)
  #define PROBE_PT_2_Y ((Y_MAX_POS) - 30)
  #define PROBE_PT_3_X ((X_MAX_POS) - 30)
  #define PROBE_PT_3_Y ((Y_MIN_POS) + 30)
#endif
